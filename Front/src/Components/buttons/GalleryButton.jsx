  ...
  return (
    <div className="gallery-button-container">
      <Link to="#" onClick={handleClick}>
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid-dots" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round" >

...
const SignUp= () => {
  ...
  const validateForm = () => {
    ...
    // Validaciones de CreateForm
    if (!firstName) newErrors.firstName = "El nombre es obligatorio";
    else if (firstName.length < 3) newErrors.firstName = "El nombre debe tener al menos 3 caracteres";
    
    if (!lastName) newErrors.lastName = "El apellido es obligatorio";
    else if (lastName.length < 3) newErrors.lastName = "El apellido debe tener al menos 3 caracteres";
    ...
    // Validaciones adicionales de SignUp
    // Aquí puedes agregar cualquier otra validación específica de SignUp
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      // Agregar solicitud al backend desde SignUp
